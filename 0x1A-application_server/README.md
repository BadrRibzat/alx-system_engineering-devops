...
Let’s serve what you built for [AirBnB clone v2 - Web framework](https://github.com/BadrRibzat/AirBnB_clone_v2/blob/master/PROJECT_0x04.md) on `web-01`. This task is an exercise in setting up your development environment, which is used for testing and debugging your code before deploying it to production.
...
Let’s serve what you built for [AirBnB clone v3 - RESTful API](https://github.com/BadrRibzat/AirBnB_clone_v3/blob/master/PROJECT_0x05.md) on `web-01`.
...
* It may be helpful to import your data (and environment variables) from [this project](https://github.com/BadrRibzat/AirBnB_clone_v2/blob/master/)
...
Let’s serve what you built for [AirBnB clone - Web dynamic](https://github.com/BadrRibzat/AirBnB_clone_v4/blob/master/PROJECT_0x06.md) on `web-01`.
...
## Student
* **Samuel Pomeroy** - [BadrRibzat](github.com/BadrRibzat)
